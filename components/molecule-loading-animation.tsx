...
const StyledWrapper = styled.div`
  ...
  .electron {
    ...
    height: 6rem;
    border-radius: 50%;
    border: 0.3rem solid rgb(114, 9, 111);
  ...
  @keyframes revolve {
    0% {
      border-color:rgba(247, 0, 255, 0.61);
      border-right: transparent;
    }
    25% {
      border-color:rgba(100, 29, 151, 0.61);
      border-bottom-color: transparent;
    }
    50% {
      border-color:rgba(72, 8, 72, 0.61);
      border-left-color: transparent;
    }
    75% {
      border-color:rgba(114, 16, 114, 0.61);
      border-top-color: transparent;
    }
    100% {
      border-color:rgba(96, 11, 117, 0.61);
